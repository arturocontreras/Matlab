function out = camera2
%CAMERA2 M-Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This M-file, CAMERA2.M, was generated from the OBJ2MFILE function.
...
%   type the name of the M-file, camera2, at the MATLAB command prompt.
%   
%   The M-file, CAMERA2.M and its associated MAT-file, CAMERA2.MAT (if
...
try
    MATvar = load('C:\Users\ARTURO\Documents\MATLAB\imagenes\camera2');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\ARTURO\Documents\MATLAB\imagenes\camera2.mat.
if (MATLoaded)
