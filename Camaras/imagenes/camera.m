function out = camera
%CAMERA M-Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This M-file, CAMERA.M, was generated from the OBJ2MFILE function.
...
%   type the name of the M-file, camera, at the MATLAB command prompt.
%   
%   The M-file, CAMERA.M and its associated MAT-file, CAMERA.MAT (if
...
try
    MATvar = load('C:\Users\José\Documents\MATLAB\imagenes\camera');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\José\Documents\MATLAB\imagenes\camera.mat.
if (MATLoaded)
