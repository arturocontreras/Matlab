...
% Last Modified by GUIDE v2.5 10-Oct-2014 10:58:36
...
slider_anterior = get(handles.slider1,'value');
...
while t<tmax
    t = toc;
    set(handles.monitor1,'string',(get(handles.slider1,'value')+20));
        if get(handles.slider1,'value') ~= slider_anterior 
